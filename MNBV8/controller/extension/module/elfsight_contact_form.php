...
class ControllerExtensionModuleElfsightContactForm extends Controller {
    ...
    const ELFSIGHT_EMBED_URL = 'https://apps.elfsight.com/embed/contact-form/?utm_source=portals&utm_medium=opencart&utm_campaign=contact-form&utm_content=sign-up';
    ...
    public function index() {
        ...
        $data['action'] = $this->url->link('extension/module/elfsight_contact_form', 'user_token=' . $this->session->data['user_token'], true);

        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);

        if (isset($this->request->post['module_contact_form_status'])) {
            $data['module_contact_form_status'] = $this->request->post['module_contact_form_status'];
        } else {
            $data['module_contact_form_status'] = $this->config->get('module_contact_form_status');
        }
