<link rel="stylesheet" href="./controller/extension/module/contact-form-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="contact-form-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Contact Form</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/contact-form-assets/popup.js';
